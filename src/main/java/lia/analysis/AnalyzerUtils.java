...
public class AnalyzerUtils {
  ...
  public static void displayTokens(TokenStream stream)
    ...
    while(stream.incrementToken()) {
      System.out.print("[" + term.buffer() + "] ");    //B
    }
  }
  /*
  ...
  */
  ...
  public static void main(String[] args) throws IOException {
    ...
    displayTokensWithFullDetails(new SimpleAnalyzer(Version.LUCENE_45),
        "The quick brown fox....");

    System.out.println("\n----");
    System.out.println("StandardAnalyzer");
    displayTokensWithFullDetails(new StandardAnalyzer(Version.LUCENE_45),
