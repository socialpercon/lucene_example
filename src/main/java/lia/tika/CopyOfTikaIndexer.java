...
// From chapter 7
public class CopyOfTikaIndexer extends Indexer {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length != 2) {
      throw new IllegalArgumentException("Usage: java " + CopyOfTikaIndexer.class.getName()
        + " <index dir> <data dir>");
    }
    ...
    CopyOfTikaIndexer indexer = new CopyOfTikaIndexer(indexDir);
  ...
  public CopyOfTikaIndexer(String indexDir) throws IOException {
    super(indexDir);
  }
  ...
  protected Document getDocument(File f) throws Exception {
    ...
    doc.add(new StringField("filename", f.getCanonicalPath(),     //14
             Field.Store.YES));
