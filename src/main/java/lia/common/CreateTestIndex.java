...
public class CreateTestIndex {
  ...
  public static Document getDocument(String rootDir, File file) throws IOException {
    ...
    doc.add(new IntField("pubmonth", Integer.parseInt(pubmonth),         // 3
                             Field.Store.YES));   // 3
    ...
    doc.add(new IntField("pubmonthAsDay", (int) (d.getTime()/(1000*3600*24)), Field.Store.NO      // 3
            ));   // 3
  ...
  public static void main(String[] args) throws IOException {
    ...
    IndexWriter w = new IndexWriter(dir,
                                    new MyStandardAnalyzer(Version.LUCENE_44),
                                    true,
