...
public class QueryParserTest extends TestCase {
  ...
  public void testTermRangeQuery() throws Exception {
    Query query = new QueryParser(Version.LUCENE_44,                        //A
                                  "subject", analyzer).parse("title2:[Q TO V]"); //A 왜 title2이지 title 아닌가?
    ...
    query = new QueryParser(Version.LUCENE_44, "subject", analyzer)  //B
