...
public class SortingExample {
  ...
  public SortingExample(IndexReader reader) {
    this.reader = reader;
...
*/
  ...
  public static void main(String[] args) throws Exception {
    ...
    QueryParser parser = new QueryParser(Version.LUCENE_45,                 // #1
                                         "contents",                             // #1
    ...
    SortingExample example = new SortingExample(reader);                     // #2
    ...
    example.displayResults(query, new Sort(new SortField[] {SortField.FIELD_SCORE, new SortField("category", SortField.Type.STRING)}));
    reader.close();
  }
}
